...
export default function RuiVisibleControl(wOParent, name, wOptions = {}, designTime = false) {
  ...
  let props = {
    ...
    addCssClass: rui.createMethod(addCssClass),
    removeCssClass: rui.createMethod(removeCssClass),
    toggleCssClass: rui.createMethod(toggleCssClass),
    hasCssClass: rui.createMethod(hasCssClass),
    ...
    fontWeight: rui.createStyle(this, "font-weight", false),
    ...
    margin: rui.createStyle(this, "margin", false),
